...
import { Armchair, CalendarDays, ChartBarIcon, Clock, MapPin } from 'lucide-react';
...
const EventCard = ({ event }: { event: EventProps }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-300 overflow-hidden">
      <img
        src={event.image}
        alt={event.title}
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center text-sm text-gray-500 font-medium">
          ...
          <span className='flex gap-1'><Armchair />{event.availableSeats} Spots Left</span>
